<template>
  <el-dialog title="Blog" :visible.sync="showPopup" class="my-dialog-class">
    <el-form
      label-position="top"
      :inline="false"
      :rules="rules"
      ...
      <el-row :gutter="15">
        ...
        <el-col :md="24">
          <el-form-item label="poza">
            <el-upload
              class="my-uploader"
              :action="baseUrl + 'Blog/upload_poza'"
          ...
          <el-form-item label="continut">
            <editor
              ...
              :init="{
                height: 500,
                images_upload_url:
                  baseUrl + 'Blog/upload_imagine_wysiwyg_continut',
  ...
  methods: {
    show_me: async function (id) {
      ...
      if (id == null) {
        ...
        this.mode = "edit";
        var result = await this.post("blog/get_info_item_dialog", { id: id });
        this.selectedObject = result.Item;
      }
    },
    async get_info() {
      var response = await this.post("blog/get_info_for_dialog");
    },
